...
public class IntroView2Activity extends AppCompatActivity {

    private static final String LOG_TAG = IntroView2Activity.class.getSimpleName();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intro_view2);
